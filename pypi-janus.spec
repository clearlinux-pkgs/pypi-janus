...
Source0  : https://files.pythonhosted.org/packages/45/50/112a19f28a11b545c4c95de29c50a06fa9381a2432eaabbf9316bbd4e046/janus-1.1.0.tar.gz
...
%prep
%setup -q -n janus-1.1.0
cd %{_builddir}/janus-1.1.0
pushd ..
cp -a janus-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730291186
...
cp %{_builddir}/janus-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-janus/840d2e227459bbd5c33423550411f4dac2758ee5 || :
