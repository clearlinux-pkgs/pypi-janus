...
Source0  : https://files.pythonhosted.org/packages/d8/7f/69884b6618be4baf6ebcacc716ee8680a842428a19f403db6d1c0bb990aa/janus-2.0.0.tar.gz
...
%prep
%setup -q -n janus-2.0.0
cd %{_builddir}/janus-2.0.0
pushd ..
cp -a janus-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735096283
